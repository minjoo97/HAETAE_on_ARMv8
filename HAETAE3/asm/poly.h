...
#else
extern void poly_add(poly *c, const poly *a, const poly *b);
extern void poly_sub(poly *c, const poly *a, const poly *b);
extern void poly_pointwise_montgomery(poly *c, const poly *a, const poly *b);
#endif
